"""Origional document https://github.com/sixbacon/RPICameraGUI"""
...
class ViewerPanel(wx.Panel):
    ...
    def fillCS(self):
        ...
        self.cbo=wx.CheckBox(self.CS, -1, '-o ', (xoffset, 440))
        ...
        """
        self.oname = wx.TextCtrl(self.CS, pos=(xoffset+40,440),size=(120, -1),value=defaultfilename)
